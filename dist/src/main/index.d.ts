...
export declare function isJsonObjectType(mixed: any): mixed is JsonObjectType;
export declare function isJsonArrayType(mixed: any): mixed is JsonArrayType;
export declare function isJsonType(mixed: any): mixed is JsonType;
